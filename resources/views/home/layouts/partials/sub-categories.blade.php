<section class="sidebar-nav-sub-wrapper py-1 px-2">
    <section class="sidebar-nav-sub-item">
        ...
        <span class="sidebar-nav-sub-item-title">
            <a href="{{ route('customer.pageAdmins', ['category' => $category->id,'search' => request()->search, 'sort' => '1', 'min_price' => request()->min_price, 'max_price' => request()->max_price, 'brands' => request()->brands]) }}"
